 ...
 * 
 */
@WebServiceClient(name = "BanqueWs", targetNamespace = "http://WebService/", wsdlLocation = "http://localhost:8888/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://WebService/", "BanqueWs");
